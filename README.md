...
```
## OUTPUT:
<img width="1100" height="705" alt="image" src="https://github.com/user-attachments/assets/3caa4824-ffa3-4706-97cf-e45ef5677e97" />

## RESULT:
Thus, to Implement Bubble Sort and Merge Sort on the GPU using CUDA to enhance the performance of sorting tasks by parallelizing comparisons and swaps within the sorting algorithm was executed successfully..
